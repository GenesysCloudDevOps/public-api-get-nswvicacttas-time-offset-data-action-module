A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get NSW/VIC/ACT/TAS Time Offset
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-nswvicacttas-time-offset-data-action-module.git?ref=v1.0.0"
    action_name        = "Get NSW/VIC/ACT/TAS Time Offset"
